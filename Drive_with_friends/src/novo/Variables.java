...
public class Variables {
    ...
    protected static final String IP_DRIVER = "127.0.1.0";
    protected static final String IP_PROTECAO_CIVIL = "127.0.1.1";

    protected static final String LOGIN = "LOGIN";
    protected static final String VALID_LOGIN = "VALID_LOGIN";
    protected static final String INVALID_LOGIN = "INVALID_LOGIN";

    protected static final String SINGUP = "SINGUP";
    protected static final String VALID_SINGUP = "VALID_LOGIN";
